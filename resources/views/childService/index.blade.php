...
<body>
    <div class="text-center">
        <h4 class="mt-2 mb-2">Child Services List</h4>
        <!-- message -->
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Customer">Add Child Services</button>
            <!-- Modal -->
            <div class="modal fade" id="Customer" tabindex="-1" aria-labelledby="CustomerLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="CustomerLabel">Add Child Services</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <!-- add form -->
                        <form action="{{ route('childService.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="border p-3 rounded">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label class="form-label">Child Icon <span class="text-danger">*</span></label>
                                            <input type="file" name="child_icon" class="form-control" required>
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label">Child Description <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="child_description" cols="30" rows="4" placeholder="e.g. Child description" required></textarea>
                                        </div>
            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $allChildData->ad_title }}</td>
                        <td>
                            <img src="{{ asset('storage/images/' . $allChildData->ad_banner) }}" alt="Icon" style="width: 90px; height: 50px;">
                        </td>
                        <td>{{ $allChildData->ad_description }}</td>
