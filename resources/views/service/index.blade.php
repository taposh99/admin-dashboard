...
<body>
    <div class="text-center">
        <h4 class="mt-2 mb-2">Services List</h4>
        <!-- message -->
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Customer">Add Service</button>
            <!-- Modal -->
            <div class="modal fade" id="Customer" tabindex="-1" aria-labelledby="CustomerLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="CustomerLabel">Add Services</h5>
                                ...
                                <div class="border p-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="service_name" placeholder="AIR FREIGHT" required>
                                        </div>
        ...
        <div class="card-body">
            <table id="datatablesSimple">
                ...
                <tbody>
                    @forelse ($serviceData as $key => $customer)
                    <tr>
                        <td>{{ $key + 1 }}</td>
